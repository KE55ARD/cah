...
<xml>
  ...
  <sql table='games' where='ID="$game"'><SET turn='$turn'><SET limit='$cards'></sql>
  <sql table='invites' where='game="$game"' select='count(*) as invites'><SET invites='$invites'></sql>
  <gamestatus blacks='$blacks' whites='$whites' myhand='$myhand' inhand='$inhand' inplay='$inplay' deck='$deck' turn='$turn' blackcard='$blackcard' pick='$pick' limit='$limit' invites='$invites' />
